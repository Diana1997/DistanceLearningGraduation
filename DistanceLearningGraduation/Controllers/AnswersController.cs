...
namespace DistanceLearningGraduation.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AnswerID,AnswerText,IsRight,QuestionID")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AnswerID,AnswerText,IsRight,QuestionID")] Answer answer)
        {
            if (ModelState.IsValid)
            {
